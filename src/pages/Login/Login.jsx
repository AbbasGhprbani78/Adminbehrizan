    ...
    const handlePasswordSubmit = async (e) => {
        ...
        if (password.trim() && phone_number) {
            ...
            try {
                ...
                toast.error(error.response?.data?.admin_error?.[0] || 'An error occurred', {
                    position: "top-left"
                });
                                        ...
                                        <div className={styles.phoneform}>
                                            <Formik
                                                ...
                                                onSubmit={async (values, { setSubmitting }) => {
                                                    try {
                                                        const response = await axios.post(`${apiUrl}/user/check-number/`, values)
                                                                ...
                                                                <Formik
                                                                    ...
                                                                    onSubmit={async (values, { setSubmitting }) => {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            const response = await axios.post(`${apiUrl}/user/password-reset/`, values)
                                                                            if (response.status === 200) {
                                                                                setShowEmail(false)
                                                                                setStep(3)
                                                                            }
                                        ...
                                        (
                                            <div className={styles.sendcodeform}>
                                                ...
                                                <Formik
                                                    ...
                                                    onSubmit={async (values, { setSubmitting }) => {
                                                        try {
                                                            const response = await axios.post(`${apiUrl}/user/password-reset-confirm/`, values)
                                                            if (response.status === 200) {
                                                                setPassword("")
                                                                setIsForget(false)
                                                                setStep(2)
                                        ...
                                        (
                                            <div className={styles.phoneform}>
                                                <Formik
                                                    ...
                                                    onSubmit={async (values, { setSubmitting }) => {
                                                        try {
                                                            const response = await axios.post(`${apiUrl}/user/check-number-admin/`, values)
                                                            localStorage.setItem("phone", values.phone_number)
                                                            if (response.status === 200) {
                                                                setStep(2)
                                                            }
                                                        } catch (error) {
                                                            toast.error("Admin users cannot log in this wa", {
                                                                position: "top-left"
                                                            })
                                                            setSubmitting(false);
                                                        }
