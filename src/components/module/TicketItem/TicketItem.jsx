...
export default function TicketItem({ ticket, onClick, onCheckboxChange }) {
  ...
  const closeTicketHnadler = async (e) => {
    ...
    try {
      const response = await axios.put(`${apiUrl}/app/ticket-admin/`, body, {
        headers,
      })
          ...
          <>
            <div className={styles.TicketLine_m}>
              <div className='d-flex align-items-center' onClick={onClick}>
                ...
                <div className=''>
                  <span className='fw-bold'>{ticket?.ticket_informations[0]?.title}</span>
                </div>
              </div>
              ...
              <div className='d-flex justify-content-between align-items-center mt-4'>
                ...
                <label className={styles.custom_checkbox}>
                  <input type="checkbox" className={styles.checkbox_input} checked={isClose} onChange={e => closeTicketHnadler(e)} />
